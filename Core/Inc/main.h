...
/* Private defines -----------------------------------------------------------*/
/* ========== F407VET6 (LQFP100) 核心板引脚映射 ==========
 * 新板无 PF/PG 端口；板载 LED2=PA6、LED3=PA7（低电平点亮）
 * LED3/LED4 为软件逻辑位，复用 PA6/PA7（兼容旧协议 0x04/0x08）
 */
...
#define AT24C02_SCL_Pin GPIO_PIN_8
#define AT24C02_SCL_GPIO_Port GPIOB
#define AT24C02_SDA_Pin GPIO_PIN_9
